...
(function() {
  var Carts, CartsItems, Resources, app, bodyParser, cart, config, cookieParser, cors, express, favicon, haltOnTimedout, item, logger, mongoose, path, routes, swagger, timeout;
